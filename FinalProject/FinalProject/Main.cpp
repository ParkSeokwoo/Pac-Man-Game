...
Texture pacman_logo_texture, ready_text_texture, gameover_text_texture, init_text_texture;
...
void initialize() {
	...
	pacman_logo_texture.initializeTexture("Pac-Man_Logo.png");
	init_text_texture.initializeTexture("init_text_texture.png");
	gameover_text_texture.initializeTexture("gameover.png");
	ready_text_texture.initializeTexture("ready.png");
...
void display() {
	...
	// Draw texture
	if (gs == INIT) {
		drawTexture(pacman_logo_texture, 0, +BOUNDARY_Y / 1.5f, BOUNDARY_X * 1.6f, pacman_logo_texture.getAspectRatio());
		drawTexture(init_text_texture, 0, -BOUNDARY_Y / 1.7f, BOUNDARY_X * 1.3f, init_text_texture.getAspectRatio());
	}
